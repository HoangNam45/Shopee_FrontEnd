                        ...
                        <TableRow>
                            <TableCell className={cx('orders_list_header')} style={{ width: '45%' }}>
                                <div>
                                    ...
                                    />
                                    <span className={cx('orders_list_body_user_name')}>dmyon26</span>
                                </div>
                            </TableCell>
                                ...
                                <div className={cx('orders_list_body_product_wrapper')}>
                                    <div className={cx('orders_list_body_product')}>
                                        <img
                                            ...
                                            alt="product"
                                        />
                                        <div className={cx('orders_list_body_product_name')}>dmyon26</div>
                                    </div>
                                    <div className={cx('orders_list_body_product_quantity')}>x1</div>
                                </div>
                            </TableCell>
                            <TableCell>
                                <div className={cx('orders_list_body_total_price')}>₫26.650</div>
                            </TableCell>
                            <TableCell>
