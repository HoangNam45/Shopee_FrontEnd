        ...
        <header className={cx('shopee-top')}>
            <div className={cx('navbar-wrapper')}>
                <div className={cx('navbar-link')}>
                    ...
                    <div className={cx('navbar-link_text', 'navbar_drawer')}>Kết nối</div>
                    <div className={cx('navbar-link_icon')}>
                        <FontAwesomeIcon icon={faFacebook} className={cx('navbar-link_icon_')} />
                        <FontAwesomeIcon icon={faSquareInstagram} className={cx('navbar-link_icon_')} />
                    </div>
                </div>
            ...
            <div className={cx('header-with-search-wrapper')}>
                <Link to="/">
                    <div className={cx('header-with-search_logo')}>
                        <svg viewBox="0 0 192 65" className={cx('header-with-search_logo_')}>
                            <g fillRule="evenodd">
                ...
                <div className={cx('header-with-search_cart')}>
                    <Link to="/cart">
                        <FontAwesomeIcon icon={faCartShopping} className={cx('header-with-search_cart_')} />
                    </Link>
                </div>
            </div>
        </header>
